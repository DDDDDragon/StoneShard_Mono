    ...
    public class MenuScene : Scene
    {
        public MenuScene() 
        {
            ...
            menu_0.RegisterChild(new Button("menuButton", hoverID: "menuButtonHover", pressID: "menuButtonPress",
                text: Main.GetText("play"), fontSize: 25, click: (sender, args) => { menuState.SwitchToState("menu_play"); }) { id = "play", HorizontalMiddle = true });

            menu_0.RegisterChild(new Button("menuButton", hoverID: "menuButtonHover", pressID: "menuButtonPress",
                text: Main.GetText("settings"), fontSize: 25) { id = "settings", HorizontalMiddle = true });

            menu_0.RegisterChild(new Button("menuButton", hoverID: "menuButtonHover", pressID: "menuButtonPress",
                text: Main.GetText("credits"), fontSize: 25) { id = "credits", HorizontalMiddle = true });

            menu_0.RegisterChild(new Button("menuButton", hoverID: "menuButtonHover", pressID: "menuButtonPress",
                text: Main.GetText("exit"), fontSize: 25) { id = "exit", HorizontalMiddle = true });
            ...
            menu_play.RegisterChild(new Button("menuButton", hoverID: "menuButtonHover", pressID: "menuButtonPress",
                text: Main.GetText("new_game"), fontSize: 25, click: (sender, args) => { menuState.SwitchToState("menu_new_game"); }) { id = "newGame", HorizontalMiddle = true });
            ...
            menu_play.RegisterChild(new Button("menuButton", hoverID: "menuButtonHover", pressID: "menuButtonPress",
                text: Main.GetText("back"), fontSize: 25, click: (sender, args) => { menuState.SwitchToState("menu_0"); } ) { id = "back", HorizontalMiddle = true });
            ...
            menu_new_game.RegisterChild(new Button("menuButton", hoverID: "menuButtonHover", pressID: "menuButtonPress",
                text: Main.GetText("adventure"), fontSize: 25) { id = "newGame", HorizontalMiddle = true });
            ...
            menu_new_game.RegisterChild(new Button("menuButton", hoverID: "menuButtonHover", pressID: "menuButtonPress",
                text: Main.GetText("back"), fontSize: 25, click: (sender, args) => { menuState.SwitchToState("menu_play"); }) { id = "back", HorizontalMiddle = true });
